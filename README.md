...
- `insurance-claim_safe.eide` — the correct design.
- `insurance-claim_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
